...
class Admin::TicketsControllerTest < ActionController::TestCase
  ...
  test "should create admin_ticket" do
    assert_difference('Admin::Ticket.count') do
      post :create, admin_ticket: { description: @admin_ticket.description, name: @admin_ticket.name, project_id: @admin_ticket.project_id }
    end
  ...
  test "should update admin_ticket" do
    patch :update, id: @admin_ticket, admin_ticket: { description: @admin_ticket.description, name: @admin_ticket.name, project_id: @admin_ticket.project_id }
    assert_redirected_to admin_ticket_path(assigns(:admin_ticket))
  end
